...
// Fonction pour générer un secret base64 (pour certaines clés)
export function generateBase64Secret(length: number = 32): string {
    return crypto.randomBytes(length).toString('base64');
}

// Fonction pour générer les fichiers .env
export function generateEnvFiles(projectName: string, backend: string, database: string): void {
    ...
    // Ajouter les variables de base de données selon le choix
    ...
    // Créer un .env à la racine pour docker-compose si nécessaire
...
// Fonction pour générer le .env.example (sans les valeurs sensibles)
